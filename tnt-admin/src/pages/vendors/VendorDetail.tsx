  ...
  return (
    <div className="space-y-5">
      ...
      <div className="tnt-card">
        ...
        {/* Business details from vendor_meta */}
        {vendor.vendor_meta && (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-5 pt-5 border-t border-[#E5E7EB] text-sm">
            <div>
              <p className="text-xs text-[#9CA3AF]">Stall</p>
              <p className="text-[#111827] font-medium">{vendor.vendor_meta.stall || '—'}</p>
            </div>
            <div>
              <p className="text-xs text-[#9CA3AF]">Business Name</p>
              <p className="text-[#111827] font-medium">{vendor.vendor_meta.business_name || '—'}</p>
            </div>
            <div>
              <p className="text-xs text-[#9CA3AF]">Email</p>
              <p className="text-[#111827] font-medium truncate">{vendor.vendor_meta.email || '—'}</p>
            </div>
            <div>
              <p className="text-xs text-[#9CA3AF]">Slot Defaults</p>
              <p className="text-[#111827] font-medium">
                {vendor.vendor_meta.slot_defaults?.slot_duration_minutes
                  ? `${vendor.vendor_meta.slot_defaults.slot_duration_minutes}m · cap ${vendor.vendor_meta.slot_defaults.default_capacity ?? '—'}`
                  : '—'}
              </p>
            </div>
          </div>
