...
import {
  ...
  ChevronLeft, ChevronRight, Zap, Activity, ClipboardList, Siren, Database, AlertTriangle, ShieldCheck, ShieldAlert, Trash2, Wallet, Clock, TrendingUp
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/slots', label: 'Slot Management', icon: Clock },
  ...
  { path: '/analytics-trends', label: 'Analytics Trends', icon: TrendingUp },
