...
const PrinterMonitoring = lazy(() => import('../pages/stationery/PrinterMonitoring'));
...
const AccessControl = lazy(() => import('../pages/administration/AccessControl'));
const SlotAdmin = lazy(() => import('../pages/slots/SlotAdmin'));
const AnalyticsTrends = lazy(() => import('../pages/analytics/AnalyticsTrends'));
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'printers', element: <PrinterMonitoring /> },
