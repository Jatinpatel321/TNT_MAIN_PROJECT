...
class TestStateMachineIntegration:
    ...
    # ── Happy path: PLACED → CONFIRMED → PREPARING → READY → (QR) PICKED ────
    ...
    # ── Student can cancel at PLACED / CONFIRMED / PREPARING / READY ────────────
