...
def get_vendor_business_hours(vendor_id: int, db: Session) -> dict[str, Any]:
    ...
    return {
        ...
        "holidays": holidays,
        "pickup_instructions": profile.pickup_instructions or "",
...
def update_vendor_business_hours(
    ...
    Args:
        ...
        pickup_instructions: Free-text pickup instructions for customers.
        db: Database session.
    ...
    if pickup_instructions is not None:
        profile.pickup_instructions = pickup_instructions
