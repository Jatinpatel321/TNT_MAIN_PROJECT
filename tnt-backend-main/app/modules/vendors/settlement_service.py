...
class VendorSettlementService:
    ...
    def get_revenue_summary(self, vendor_id: int) -> Dict[str, Any]:
        """Get revenue summary with online/refund breakdown (online-prepaid only)."""
        ...
        return {
            ...
            "today": {
                ...
                "net_revenue": round(today_online_rupees - today_refunds_rupees, 2),
            },
            "breakdown": {
    ...
    def get_transactions(self, vendor_id: int, days: int = 30) -> Dict[str, Any]:
        ...
        return {
            ...
            "summary": {
                ...
                "net_revenue": round(total_online - total_refunds - total_fees, 2),
            },
        }
